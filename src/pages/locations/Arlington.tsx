...
const cityInfo = {
  ...
  neighborhoods: "Arlington Heights, Clarendon, Ballston, Crystal City",
  description: "serving Arlington Heights, Clarendon, and Ballston",
  ...
  return (
    <>
      <Helmet>
        ...
        <link
          rel="canonical"
          href={`https://mgnpools.com/locations/arlington-pool-service`}
        />
        ...
        <meta property="og:url" content={`https://mgnpools.com/locations/arlington-pool-service`} />
