...
const cityInfo = {
  ...
  neighborhoods: "Mount Vernon Estate, Fort Belvoir, Hybla Valley",
  description: "serving Mount Vernon Estate and Fort Belvoir areas",
  geo: { latitude: "38.7232", longitude: "-77.1072" }
};
  ...
  return (
    <>
      <Helmet>
        ...
        <link
          rel="canonical"
          href={`https://mgnpools.com/locations/mount-vernon-pool-service`}
        />
        ...
        <meta property="og:url" content={`https://mgnpools.com/locations/mount-vernon-pool-service`} />
