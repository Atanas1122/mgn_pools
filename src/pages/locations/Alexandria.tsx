...
const cityInfo = {
  ...
  neighborhoods: "Old Town, Del Ray, West End, Rosemont",
  description: "serving Old Town and Del Ray neighborhoods",
  ...
  return (
    <>
      <Helmet>
        ...
        <link
          rel="canonical"
          href={`https://mgnpools.com/locations/alexandria-pool-service`}
        />
        ...
        <meta property="og:url" content={`https://mgnpools.com/locations/alexandria-pool-service`} />
