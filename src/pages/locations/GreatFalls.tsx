...
const cityInfo = {
  ...
  neighborhoods: "Colvin Run, Forestville, Seneca Hunt, River Bend",
  description: "serving Colvin Run, Forestville, and River Bend",
  geo: { latitude: "39.0065", longitude: "-77.2883" }
};
  ...
  return (
    <>
      <Helmet>
        ...
        <link
          rel="canonical"
          href={`https://mgnpools.com/locations/great-falls-pool-service`}
        />
        ...
        <meta property="og:url" content={`https://mgnpools.com/locations/great-falls-pool-service`} />
