...
const cityInfo = {
  ...
  state: "MD",
  fullName: "Maryland",
  neighborhoods: "Bethesda, Chevy Chase, Potomac, Rockville, Silver Spring, Takoma Park",
  description: "serving Bethesda, Chevy Chase, Potomac, and Rockville",
...
const services = [
  {
    ...
    description: `MGN Pools Management specializes in providing quality commercial pool management services in ${cityInfo.fullName} and throughout the DC metro area. Our team guarantee the fastest response to anything related to your swimming pool. We offer customized solutions that will fit our clients unique needs.`,
    link: "/commercial"
  },
  {
    icon: HomeIcon,
  ...
  return (
    <>
      <Helmet>
        ...
        <link
          rel="canonical"
          href={`https://mgnpools.com/locations/maryland-pool-service`}
        />
        ...
        <meta property="og:url" content={`https://mgnpools.com/locations/maryland-pool-service`} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              Premier pool company providing pool service and pool management in {cityInfo.fullName}, {cityInfo.description}, and across the DC metro area
            </p>
          </motion.div>
